...
// Screen-only toolbar for the schedule print view. It offers a manual "Print /
// Save as PDF" button and a link back to the Schedules tab, and — since the
// user reached this page by asking to print — it opens the browser's print
// dialog once automatically on load. The toolbar is hidden in the print output.
