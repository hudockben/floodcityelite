...
// Screen-only toolbar for the payment report. It offers a manual "Print / Save
// as PDF" button and a link back to the Payment Tracker, and — since the user
// reached this page by asking for a PDF — it opens the browser's print dialog
// once automatically on load. The toolbar is hidden in the print output.
